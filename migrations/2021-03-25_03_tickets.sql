ALTER TABLE `tickets`
ADD `leido_destinatario` int(11) NOT NULL AFTER `idUsuarioAsignado`;
ALTER TABLE `tickets`
ADD `leido_remitente` int(11) NOT NULL AFTER `leido_destinatario`;

ALTER TABLE `tickets`
ADD INDEX `leido_destinatario` (`leido_destinatario`);

ALTER TABLE `tickets`
ADD INDEX `leido_remitente` (`leido_remitente`);
