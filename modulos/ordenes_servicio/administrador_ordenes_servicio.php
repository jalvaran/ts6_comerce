<?php
/**
 * Pagina para administrar las ordenes de servicio
...
$myPage=$Pagina;
$myTitulo="Administrador Ordenes de Servicio";
                        ...
                        print('<div id="" class="btn-group pull-right" role="">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" x-placement="top-end" style="position: absolute; transform: translate3d(-93px, -189px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                <a class="dropdown-item" onclick="listado_id=1;VerListadoSegunID();"><i class="icon-user"></i> Usuarios</a>
                                                <a class="dropdown-item" onclick="listado_id=2;VerListadoSegunID();"><i class="icon-people"></i> Técnicos</a>                                                
                                                <a class="dropdown-item" onclick="listado_id=4;VerListadoSegunID();"><i class="icon-list"></i> Insumos</a>
...
print('<script src="jsPages/administrador_ordenes_servicio.js"></script>'); 
