<?php
/**
 * Pagina para manejar las ordenes de servicio
 * 2021-03-29, Julian Alvaran Techno Soluciones SAS
 * 
...
$css->PageInit($myTitulo);
    ...
    $css->CModal("btnModalView", "onclick=SeleccioneAccionFormularios();", "button", "Guardar");
    $css->div("div_spinner", "", "", "", "", "", "");
                ...
                $css->div("", "mailbox-container", "", "", "", "", "");
                    $css->div("", "action", "", "", "", "", '');
                        ...
                        $css->div("", " btn-group col-md-3", "", "", "", "", '');
                            ...
                            $css->select("empresa_id", "form-control", "empresa_id", "", "", "onchange=listado_ordenes_servicio();", "");
                        ...
                        if($Role=='ADMINISTRADOR' or $Role=='SUPERVISOR' or $Role=='ADMIN_ORDEN_SERVICIO'){
                        print('<div id="" class="btn-group pull-right" role="">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="top-end" style="position: absolute; transform: translate3d(-93px, -189px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                    ...
                                                    <a class="dropdown-item" onclick="listado_ordenes_servicio()"><li class="far fa-list-alt"></li> Listado General</a>
                                                    <a class="dropdown-item" onclick="dibuja_tabla(`get`,`terceros`,`1`,`DivListados`)"><li class="fa fa-address-book"></li> Crear Tercero</a>
                                                    <a class="dropdown-item" onclick="frm_crear_editar_orden_servicio();"><li class="fa fa-plus-circle"></li> Crear Orden de Servicio</a>
    ...
    $css->div("", "row", "", "", "", "", "");
        print('<div class="col-md-12">');
            print('<div class="panel panel">');
                $css->div("DivListados", "panel-body", "", "", "", "", "");
...
print('<script src="jsPages/ordenes_servicio.js"></script>'); 
